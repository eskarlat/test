...
const factory: ExtensionRouterFactory = (context) => {
  ...
  // GET /tools — list Figma MCP tools
  ...
  // POST /call — invoke a Figma MCP tool
  ...
  // GET /resources — list Figma MCP resources
  ...
  // GET /resource?uri=... — read a specific Figma MCP resource
